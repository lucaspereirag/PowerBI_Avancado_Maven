-- CREATE DATABASE UDEMY_SQL_EXERCICIOS
-- USE UDEMY_SQL_EXERCICIOS



DROP TABLE [TB_NETFLIX]
...
(
	...
	[ESTADOS] VARCHAR(20),
	[UF] VARCHAR(10),
	[TOTAL_USUARIOS] SMALLINT,
	[PERIODO_DE_ACESSOS] VARCHAR(10),
...
INSERT INTO [TB_NETFLIX] ([DATA],[ESTADOS],[UF],[TOTAL_USUARIOS],[PERIODO_DE_ACESSOS],[SEGMENTOS],[TIPO_DE_CONTA],[VALOR]) VALUES 
 ...
 SELECT * 
 FROM [TB_NETFLIX]
 WHERE [DATA] BETWEEN '01/01/2019' AND '05/01/2019'
 ORDER BY [DATA] 
...
SELECT
	...
	ESTADOS,
	TIPO_DE_CONTA,
	COUNT(TIPO_DE_CONTA) AS QTD_TIPO_CONTA
FROM 
	TB_NETFLIX
...
SELECT
	[DATA] AS DATA_DO_CONSUMO,
	PERIODO_DE_ACESSOS AS PERIODOS,
	TIPO_DE_CONTA AS SERVICOS,
	ESTADOS,
	TOTAL_USUARIOS,
	SEGMENTOS,
...
WHERE
	[DATA] BETWEEN '04/01/2019' AND '05/02/2019' 
AND
	SEGMENTOS = 'DOCUMENTARIOS'